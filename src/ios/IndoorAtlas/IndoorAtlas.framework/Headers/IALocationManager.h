...
typedef NS_ENUM(NSInteger, ia_calibration) {
     ...
     * @deprecated Deprecated since SDK 3.0
     */
    kIACalibrationPoor __attribute__((deprecated("Deprecated since SDK 3.0"))),

    /**
     * Quality is good.
     * @deprecated Deprecated since SDK 3.0
     */
    kIACalibrationGood __attribute__((deprecated("Deprecated since SDK 3.0"))),

    /**
     * Quality is excellent.
     * @deprecated Deprecated since SDK 3.0
     */
    kIACalibrationExcellent __attribute__((deprecated("Deprecated since SDK 3.0"))),
