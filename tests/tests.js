...
exports.defineAutoTests = function () {
  ...
  describe('getCurrentPosition method', function () {
    ...
    describe('error callback', function () {
      ...
      it("test.spec.10 should be called if we set timeout to 0", function (done) {
        if (skipAndroid) {
          pending();
        }
        ...
        it("test.spec.11 on failure should return PositionError object with error code constants", function (done) {
          if (skipAndroid) {
            pending();
          }
        ...
        describe('success callback', function () {
          ...
          it("test.spec.12 should be called with a Position object", function (done) {
            if (skipAndroid) {
              pending();
            }
          ...
          it("test.spec.13 should be called if we set timeout to 0", function (done) {
            ...
            describe('fetchFloorPlanWithID method', function () {
              describe('error callback', function () {
                ...
                it("test.spec.16 Failed as Wrong FloorPlan id Pass", function (done) {
                  if (skipAndroid) {
                    pending();
                  }
              ...
              describe('success callback', function () {
                it("test.spec.17 should be called with a fetchFloorPlan object", function (done) {
                  if (skipAndroid) {
                    pending();
                  }
                ...
                it("test.spec.18 should be called error object as wrong floor plan pass ", function (done) {
                  if (skipAndroid) {
                    pending();
                  }
            ...
            describe('setPosition method', function () {
              describe('success callback', function () {
                ...
                it("test.spec.19 should be called to setPosition", function (done) {
                  if (skipAndroid) {
                    pending();
                  }
